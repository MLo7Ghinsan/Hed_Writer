...
def click1():
    ...
    def phone_name():
        ...
        def click2():
            ...
            with open(f"{entered_name}.txt", "a+") as file:
                file.write("\n")
                file.write("QS          " + f'"L-phoneme_' + f'{phone_name1}"' + "          " + "{" + f"*^{entered_phoneme}-*" + "}\n")
                file.write("QS          " + f'"C-phoneme_' + f'{phone_name1}"' + "          " + "{" + f"*-{entered_phoneme}+*" + "}\n")
                file.write("QS          " + f'"R-phoneme_' + f'{phone_name1}"' + "          " + "{" + f"*+{entered_phoneme}=*" + "}\n")
        Label (window, text="Enter your phoneme syllable(s)", font="none 12 bold") .grid(row=13, column=0, sticky=W)
        Button(window, text="ADD", width=8, command=click2) .grid(row=15, column=0, sticky=W)
    ...
    Label (window, text=" ", font="none 12 bold") .grid(row=16, column=0, sticky=W)
    Label (window, text=" ", font="none 12 bold") .grid(row=17, column=0, sticky=W)
    Label (window, text=" ", font="none 12 bold") .grid(row=18, column=0, sticky=W)
    Label (window, text="click this button AFTER you press [Make HED]", font="none 12 bold", fg="gray") .grid(row=19, column=0, sticky=W)
    ...
    def get_indim_value():
        with open(f"{entered_name}.hed", "r") as linecount:
            ...
            Label (window, text=f"in_dims:", font="none 12 bold") .grid(row=21, column=0, sticky=W)
            Label (window, text=f"acoustic [ {indim_count4acoustic} ]", font="none 12") .grid(row=22, column=0, sticky=W)
            Label (window, text=f"timelag [ {indim_count} ]", font="none 12") .grid(row=23, column=0, sticky=W)
            Label (window, text=f"duration [ {indim_count} ]", font="none 12") .grid(row=24, column=0, sticky=W)
    Button(window, text="Get in_dim", width=8, command=get_indim_value) .grid(row=20, column=0, sticky=W)
    ...
    Button(window, text="Make Hed", width=8, command=touch_cqs) .grid(row=20, column=1, sticky=W)
